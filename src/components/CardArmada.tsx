...
export default function CardArmada({
  judul,
  image,
  price,
  transmisi,
  ...
  *HALO SAYA INGIN MEMESAN*
  ...
  Saya tertarik untuk melakukan pemesanan mobil. Mohon informasi lebih lanjut mengenai ketersediaan unit ${judul} dan proses pemesanan.
          ...
          <div className="grid grid-cols-1 gap-2">
            ...
            <div className="flex items-center justify-between border-b border-white/20 py-1">
              ...
              <span className="font-medium">
                {kapasitas ? kapasitas + " " + "Orang" : "Menyesuaikan"}{" "}
              </span>
            </div>
