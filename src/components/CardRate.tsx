...
export default function CardRate({
  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col items-center rounded-xl bg-white p-6 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl">
      <img
        src={image}
        alt="User"
