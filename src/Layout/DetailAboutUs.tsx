  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={"Profil lengkap CV Tujuh Sembilan Oto Rentcar — penyedia layanan rental mobil terpercaya di Berau dengan armada terawat dan tim profesional untuk kebutuhan pribadi, bisnis, maupun proyek tambang.".slice(
            0,
            155,
          )}
        />
        <link
          rel="canonical"
          href="https://cvtujuhsembilanotorentcar.com/tentangkami"
        />
        ...
        <meta
          property="og:title"
          content="Tentang Kami – CV Tujuh Sembilan Oto Rentcar Berau"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://cvtujuhsembilanotorentcar.com/tentangkami"
        />
        <meta
          property="og:image"
          content={foto1 /* gunakan URL absolut, contoh: "https://..." */}
        />
        ...
        />
        <meta name="twitter:image" content={foto1 /* URL absolut */} />
      </Helmet>
            ...
            <div className="grid items-center gap-12 md:grid-cols-1">
              <div>
                ...
                <p className="text-lg leading-relaxed text-gray-600">
                  ...
                  keperluan pribadi, bisnis, hingga proyek-proyek besar di
                  sektor pertambangan.
                </p>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div data-aos="fade-left" className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-xl text-gray-600">
              Solusi transportasi lengkap untuk berbagai kebutuhan perjalanan
              Anda
            </p>
          </div>
