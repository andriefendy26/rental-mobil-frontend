...
const BookingSectionComp = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Main container */}
      <div className="relative z-50 flex flex-col overflow-hidden rounded-2xl border-2 border-gray-200 bg-white/80 p-6 px-12 shadow-2xl backdrop-blur-sm md:mx-24 lg:-top-14 lg:mx-16">
        {/* Progress indicator */}
